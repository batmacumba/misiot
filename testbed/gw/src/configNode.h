...
wpas wpa[] = {
	{ "", "" },
	{ "Obi Wan Kenobi_IoT", "oladobomdaforca" }
};
...
#define _DESCRIPTION "MISIoT Gateway"			// Name of the gateway
#define _EMAIL "brunocarneirodacunha@usp.br"		// Owner
#define _PLATFORM "ESP32"
#define _LAT -23.532571
#define _LON -46.689592
#define _ALT 760								// Altitude
